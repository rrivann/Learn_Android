...
import com.dicoding.mynoteappsuseroom.databinding.ActivityNoteAddUpdateBinding
import com.dicoding.mynoteappsuseroom.helper.DateHelper
import com.dicoding.mynoteappsuseroom.ui.viewmodels.NoteAddUpdateViewModel
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.activity_form_add_update -> showAlertDialog(ALERT_DIALOG_CLOSE)
        }
